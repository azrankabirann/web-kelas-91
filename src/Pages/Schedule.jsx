...
const Schedule = () => {
  ...
  if (currentWeek === 2 || currentWeek === 4) {
    piketGroup = [
      ["Ariel", "Fawwaz", "Dwi", "Ega", "Febry", "Husna"],
      ["Azran", "Hapis", "IntanS", "IntanR", "Fitri", "Isnaini"],
      ["NurAlamsyah", "Nayla", "Nabila", "Nadira", "Nadia", "Ridho"],
      ["Nazmi", "Serena", "NovitaS", "NovitaA", "Neriza", "Qayla"],
      ["Raka", "Rara", "Raesya", "Cinta", "Rafika", "Risma"],
      ["Rizky","Imah", "Syifa", "Wulan", "Safna", "Usamah"]
    ];
